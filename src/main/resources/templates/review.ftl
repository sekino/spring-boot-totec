...
<html>
  <head>
    ...
    <title>レビュー: 商品It000000 レビューワーUs000000 のページ</title>
    ...
    <div class="app">
      ...
      <div class="userReview p-t">
        <blockquote class="blockquote">
          <p>この商品、いい感じ。</p>
          <footer>by <img src="/img/user/Us000000.png" alt="Us000000のサムネイル画像" class="img-circle" width="24" height="24" style="vertical-align: bottom;"> Us000000</cite></footer>
        </blockquote>
        <!-- review info -->
        <div class="reviewInfo text-muted p-l p-r p-b" style="font-size: 0.8rem;">
          <p class="m-b-0">投稿日時: 2015年7月12日 19:38</p>
          <p class="m-b-0">商品の評価点数: 87</p>
          <p class="m-b-0">商品に対するアクションステータス: 購入済み</p>
        </div>
      </div>
      ...
      <div class="users">
        ...
        <div class="row p-l p-r m-r-0">
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000001.png" alt="商品Us000001のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000002.png" alt="商品Us000002のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000003.png" alt="商品Us000003のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000004.png" alt="商品Us000004のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000005.png" alt="商品Us000005のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000006.png" alt="商品Us000006のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
          <div class="col-xs-3 p-a-0 p-b text-center">
            <img src="/img/user/Us000007.png" alt="商品Us000007のサムネイル画像" class="img-circle" width="48" height="48">
          </div>
        </div>
      </div>
